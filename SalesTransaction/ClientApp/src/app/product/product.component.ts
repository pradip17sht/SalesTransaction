...
import { MvEditProduct, MvProduct } from './product.model';
...
export class ProductComponent implements OnInit {
  ...
  selectedProduct: MvEditProduct = <MvEditProduct>{};
  ...
  ngOnInit(): void {
    this.displayedColumns = ['productId', 'productName', 'description', 'price', 'rate', 'startDate', 'endDate'];
